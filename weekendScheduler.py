'''
Author: Alex Archer
Date of last modification: 2-24-2020
...
if  not raPreferences:
    ...
    #print("danger, input has failed, switching to default values to avoid crash!")
    #in case input fails!
...
if raPreferences.get(3): #setting key
    ...
    print("danger, input has failed, bad pairings settings were not passed or defined.")
...
if dictlen != 0:
    ...
    print("danger, input has failed, there are 0 entries. swapping to default average")
    avg = 6
